...
# ---- Model + DDP ----
    ...
    # Configuration for Shallow-Zone Focus
    WET_BATCH_QUOTA = 20
    accumulation_steps = 2 

    SHALLOW_THRESHOLD = 1.5  # Focus on depths < 2m
    DRY_THRESHOLD = 0.025    # Standard dry/wet cutoff
    ...
    for ep in outer_loop:
            ...
            for batch_data in train_loader:
                ...
                # --- GENERATE GLOBAL BATHTUB BASELINE ---
                ...
                # Patch Processing - Seeking Shallow/Boundary Patches
                for spatial_batch in all_batches:
                    ...
                    for (i_s, j_s) in spatial_batch:
                        ...
                        # IMPLEMENT STRATEGY: Target selection
                    ...
                    # STAGE 2: Individual patch backward
